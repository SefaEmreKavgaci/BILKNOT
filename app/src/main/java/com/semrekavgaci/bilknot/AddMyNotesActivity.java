                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    newReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override public void onSuccess(Uri uri) {
                            ...
                            firebaseFirestore.collection(FirebaseAuth.getInstance().getCurrentUser().getEmail()).add(postData).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                @Override
                                public void onSuccess(DocumentReference documentReference) {
                                    Intent intent = new Intent(AddMyNotesActivity.this, MyNotesActivity.class);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AddMyNotesActivity.this,e.getLocalizedMessage().toString(),Toast.LENGTH_LONG).show();
                                } });
                        }
                    });
